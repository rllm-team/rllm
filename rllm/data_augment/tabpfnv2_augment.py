...
def prepare_regression_ensemble(
    X_train: np.ndarray,
    y_train: np.ndarray,
    *,
    n_estimators: int = 4,
    ...
    Args:
        ...
        augmentor_configs: Custom augmentor configs. If None, uses defaults.
        target_transforms: Target transformations. If None, uses [None].
        random_state: Random seed for reproducibility. Default is 0.
        n_workers: Number of workers for parallel preprocessing. Default is 1.
        parallel_mode: Parallelization mode. Default is "block".
        cat_ix: List of categorical feature indices. Default is None.
