...
class TimestampEncoder(ColEncoder):
    ...
    def post_init(self) -> None:
        ...
        if self.fill_nan:
            ...
            median_time = TimestampPreprocessor.to_tensor(median_time)  # [Col, num_time_feats]
        ...
        self.weight = Parameter(
            torch.empty(num_cols, len(TimestampPreprocessor.TIME_TO_INDEX),
                        self.out_size, self.out_dim))
