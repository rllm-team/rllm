...
users = pd.read_csv('yourpath/classification/users.csv')#/../datasets/rel-movielens1m/classification//movies/train.csv
train_movies = pd.read_csv('yourpath/classification/train.csv')#/../datasets/rel-movielens1m/classification/movies/train.csv
validation_movies = pd.read_csv('yourpath/classification/movies/validation.csv')#/../datasets/rel-movielens1m/classification/movies/validation.csv
test_movies = pd.read_csv('yourpath/classification/movies/test.csv')#/../datasets/rel-movielens1m/classification/movies/test.csv
ratings = pd.read_csv('yourpath/classification/ratings.csv')
...
clf.fit(
    ...
    num_workers=0,
    drop_last=False,
    loss_fn=[torch.nn.functional.cross_entropy]*8 # Optional, just an example of list usage
) 
