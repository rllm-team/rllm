...
# MSE: 0.64902
# Runtime: 1082s (on a single 32G GPU)
# Cost: N/A
# Usage: lib
...
model = nn.Sequential(
    lib.DenseBlock(in_features, 128, num_layers=1, tree_dim=3, depth=6, flatten_output=False,
...
optimizer_params = { 'nus':(0.7, 1.0), 'betas':(0.9, 0.995) }
