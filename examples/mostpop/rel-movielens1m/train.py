'''
# Improved from MostPop algorithm
MostPop: A re-visit of the popularity baseline in recommender systems
"https://dl.acm.org/doi/abs/10.1145/3397271.3401233"
...
import sys
sys.path.insert(0, '/home/user/cxr/4-21/daisyRec')  # Reccurrent path of file daisyrec 
