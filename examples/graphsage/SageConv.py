...
class SageGCN(nn.Module):
    def __init__(self, input_dim, hidden_dim,
        ...
        Args:
            ...
            aggr_neighbor_method: Method for aggregating neighbor features,
            options include ["mean", "sum", "max"].
            aggr_hidden_method: Method for updating node features,
            options include ["sum", "concat"].
        """
